 ...
 * Return: size of list
 */
list_s *create_node(list_s **head, const char *str, int num)
{
	list_s *new_head;
...
/**
 * print_str_part - prints only the str element of a list_s linked list
 * @h: pointer to first node
 *
 * Return: size of list
 */
size_t print_str_part(const list_s *h)
{
	size_t i = 0;
...
/**
 * delete_atindex - deletes node at given index
 * @head: address of pointer to first node
 * @index: index of node to delete
 *
 * Return: 1 on success, 0 on failure
 */
int delete_atindex(list_s **head, unsigned int index)
{
...
/**
 * freemem_list - frees all nodes of a list
